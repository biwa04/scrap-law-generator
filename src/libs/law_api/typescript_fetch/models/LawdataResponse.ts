...
import type { AttachedFilesInfo } from './AttachedFilesInfo.ts';
import {
    AttachedFilesInfoFromJSON,
    AttachedFilesInfoFromJSONTyped,
    AttachedFilesInfoToJSON,
} from './AttachedFilesInfo.ts';
import type { LawInfo } from './LawInfo.ts';
import {
    LawInfoFromJSON,
    LawInfoFromJSONTyped,
    LawInfoToJSON,
} from './LawInfo.ts';
import type { RevisionInfo } from './RevisionInfo.ts';
import {
    RevisionInfoFromJSON,
    RevisionInfoFromJSONTyped,
    RevisionInfoToJSON,
} from './RevisionInfo.ts';
