import { LawBodyType, LawNumType, LawTitleType, LawType } from "../types/law.ts";
import { numbersToKanji } from "../utils/helper.ts";
import { XMLParser } from "npm:fast-xml-parser";
import { Era, RevisionInfo } from "../typescript_fetch/index.ts";
